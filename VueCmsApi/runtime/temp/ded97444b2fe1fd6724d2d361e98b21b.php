<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:93:"G:\phpstudy\PHPTutorial\WWW\VueCmsApi\public/../application/index\view\good_images\index.html";i:1527947814;s:87:"G:\phpstudy\PHPTutorial\WWW\VueCmsApi\public/../application/index\view\common\base.html";i:1527947967;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>商品轮播图列表--VueCmsApi后台系统</title>
    <meta charset="utf-8">
...
<h1><i class="fa fa-edit"></i> 商品轮播图列表</h1>
    ...
    <li class="breadcrumb-item">商品轮播图列表</li>
    ...
    <div class="tile">
        <table class="table table-bordered">
          ...
          <tbody>
          	<?php if(is_array($goodImages) || $goodImages instanceof \think\Collection || $goodImages instanceof \think\Paginator): $i = 0; $__LIST__ = $goodImages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goodImage): $mod = ($i % 2 );++$i;?>
	            <tr>
	              <td><?php echo $goodImage['goodimages_id']; ?></td>
				  <td><?php echo $goodImage['title']; ?></td>
	              <td><img src="<?php echo $goodImage['url']; ?>" width="60" height="30"></td>
	            </tr>
        ...
        <ul class="pagination">
	    	...
	    	<?php endif; $__FOR_START_10743__=1;$__FOR_END_10743__=$pages+1;for($page=$__FOR_START_10743__;$page < $__FOR_END_10743__;$page+=1){ if($page==$current_page): ?>
