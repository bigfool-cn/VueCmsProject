<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"G:\phpstudy\PHPTutorial\WWW\VueCmsApi\public/../application/index\view\swipe\index.html";i:1525876719;s:87:"G:\phpstudy\PHPTutorial\WWW\VueCmsApi\public/../application/index\view\common\base.html";i:1525872306;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>轮播图列表--VueCmsApi后台系统</title>
    <meta charset="utf-8">
...
<h1><i class="fa fa-edit"></i> 轮播图列表</h1>
    ...
    <li class="breadcrumb-item">轮播图列表</li>
    ...
    <div class="tile">
        <table class="table table-bordered">
          ...
          <tbody>
          	<?php if(is_array($swipes) || $swipes instanceof \think\Collection || $swipes instanceof \think\Paginator): $i = 0; $__LIST__ = $swipes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$swipe): $mod = ($i % 2 );++$i;?>
	            <tr>
	              <td><?php echo $swipe['id']; ?></td>
	              <td><?php echo $swipe['url']; ?></td>
	              <td><img src="<?php echo $swipe['img']; ?>" width="60" height="30"></td>
	            </tr>
        ...
        <ul class="pagination">
	    	...
	    	<?php endif; $__FOR_START_28909__=1;$__FOR_END_28909__=$pages+1;for($page=$__FOR_START_28909__;$page < $__FOR_END_28909__;$page+=1){ if($page==$current_page): ?>
