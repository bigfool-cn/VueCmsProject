<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"G:\phpstudy\PHPTutorial\WWW\VueCmsApi\public/../application/index\view\goods\index.html";i:1527948150;s:87:"G:\phpstudy\PHPTutorial\WWW\VueCmsApi\public/../application/index\view\common\base.html";i:1527947967;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>商品列表--VueCmsApi后台系统</title>
    <meta charset="utf-8">
...
<h1><i class="fa fa-edit"></i> 商品列表</h1>
    ...
    <div class="tile">
          ...
          <tbody>
          	<?php if(is_array($goods) || $goods instanceof \think\Collection || $goods instanceof \think\Paginator): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($i % 2 );++$i;?>
	            <tr>
				  ...
				  <td><?php echo $good['stock_quantity']; ?></td>
				  <td><?php echo $good['click']; ?></td>
				  <td><img src="<?php echo $good['face']; ?>" width="60" height="30"></td>
				  <td><?php echo date("Y-m-d H:i:s",strtotime($good['add_time'])); ?></td>
				  <td><a href="<?php echo url('index/GoodImages/add'); ?>?id=<?php echo $good['id']; ?>">添加轮播图</a></td>
	            </tr>
        ...
        <ul class="pagination">
	    	...
	    	<?php endif; $__FOR_START_32624__=1;$__FOR_END_32624__=$pages+1;for($page=$__FOR_START_32624__;$page < $__FOR_END_32624__;$page+=1){ if($page==$current_page): ?>
