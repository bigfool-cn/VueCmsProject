<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"G:\phpstudy\PHPTutorial\WWW\VueCmsApi\public/../application/index\view\user\index.html";i:1528979876;s:87:"G:\phpstudy\PHPTutorial\WWW\VueCmsApi\public/../application/index\view\common\base.html";i:1528979781;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>会员列表--VueCmsApi后台系统</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="/uploads/user.jpg" alt="User Image" width="50px" height="50px">
        <div>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview" id="m-7"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-map"></i><span class="app-menu__label">会员管理</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="<?php echo url('index/User/index'); ?>" id="m-7-1"><i class="icon fa fa-circle-o"></i> 会员列表</a></li>
          </ul>
        </li>
      </ul>
    </aside>
...
<h1><i class="fa fa-edit"></i> 会员列表</h1>
    ...
    <div class="tile">
        ...
        <ul class="pagination">
	    	...
	    	<?php endif; $__FOR_START_31307__=1;$__FOR_END_31307__=$pages+1;for($page=$__FOR_START_31307__;$page < $__FOR_END_31307__;$page+=1){ if($page==$current_page): ?>
