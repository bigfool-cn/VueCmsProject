<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"G:\phpstudy\PHPTutorial\WWW\VueCmsApi\public/../application/index\view\image\index.html";i:1526906641;s:87:"G:\phpstudy\PHPTutorial\WWW\VueCmsApi\public/../application/index\view\common\base.html";i:1526903643;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>图文列表--VueCmsApi后台系统</title>
    <meta charset="utf-8">
...
<h1><i class="fa fa-edit"></i> 图文列表</h1>
...
<li class="breadcrumb-item">图文列表</li>
...
<div class="tile">
    <table class="table table-bordered">
        ...
        <tbody>
        <?php if(is_array($imgs) || $imgs instanceof \think\Collection || $imgs instanceof \think\Paginator): $i = 0; $__LIST__ = $imgs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;?>
        <tr>
            <td><?php echo $img['img_id']; ?></td>
            <td><?php echo $img['img_title']; ?></td>
            <td><?php echo $img['title']; ?></td>
            <td><img src="<?php echo $img['img']; ?>" width="60" height="30"></td>
        </tr>
    ...
    <ul class="pagination">
        ...
        <?php endif; $__FOR_START_6270__=1;$__FOR_END_6270__=$pages+1;for($page=$__FOR_START_6270__;$page < $__FOR_END_6270__;$page+=1){ if($page==$current_page): ?>
